...
Discover Weekly and Release Radar reset every week with no way to go back. Daylist changes multiple times a day and there's no history. This project makes it easy to save those playlists before they disappear.

It also lets you expand a playlist into full albums from whichever source the track was released, and instead of tracks the algorithm chose, browse the albums instead.

Nothing here takes anything away from Spotify. It's a tool to enhance your experience on a platform you're already paying for.
...
See [docs/SELF_HOSTING.md](docs/SELF_HOSTING.md) for custom domain and nginx reverse proxy configuration.
...
See the [Privacy Policy](https://spotifyscripts-web.vercel.app/privacy) (also available at [docs/PRIVACY.md](docs/PRIVACY.md)). We don't track anything, collect data, or store anything beyond your encrypted session cookie. No analytics, no telemetry. You can revoke access anytime at [spotify.com/account/apps](https://www.spotify.com/account/apps/).
